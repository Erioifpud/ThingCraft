...
public class GuiAdvTextField extends Gui {
    ...
    public GuiAdvTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, String key) {
        this(componentId, fontrendererObj, x, y, par5Width, par6Height, key, "");
    }
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                ...
                drawRect(this.xPosition, this.yPosition + this.height - 1, this.xPosition + this.width, this.yPosition + this.height, 0x80ffffff);
            }
            //color
            ...
            if (flag1) {
                //is selected and blink
                if (flag2) {//is selected text
            ...
            if (isFocused()) {
                drawRect(this.xPosition, this.yPosition + this.height - 1, this.xPosition + this.width, this.yPosition + this.height, 0xffffffff);
            } else if (getText().isEmpty()) {
                this.fontRendererInstance.drawStringWithShadow(tips, (float) l, (float) i1, 0xffbdc3c7);
            }
